---
name: "source-command-update-nicomedkey"
description: "nicomedkeyをMisskey最新リリースへ追従し、公開手順をActions運用に揃える"
---

# source-command-update-nicomedkey

Use this skill when the user asks to run the migrated source command `update-nicomedkey`.
